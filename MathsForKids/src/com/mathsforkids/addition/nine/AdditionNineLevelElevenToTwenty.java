...
public class AdditionNineLevelElevenToTwenty extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(AdditionNineLevelElevenToTwenty.this, levelTick);
					Intent intent = new Intent(AdditionNineLevelElevenToTwenty.this, AdditionNineLevelSelect.class);
