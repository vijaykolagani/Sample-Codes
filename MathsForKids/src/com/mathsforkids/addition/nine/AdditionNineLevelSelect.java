package com.mathsforkids.addition.nine;
...
public class AdditionNineLevelSelect extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intentOneToTen = new Intent(AdditionNineLevelSelect.this,
				AdditionNineLevelOneToTen.class);
		intentElevenToTwenty = new Intent(AdditionNineLevelSelect.this,
				AdditionNineLevelElevenToTwenty.class);
		intentTwentyOneToThirty = new Intent(AdditionNineLevelSelect.this,
				AdditionNineLevelTwentyOneToThirty.class);
	...
	public void onClick(View v) {
		...
		case R.id.level_one:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_one);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_ONE_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_ONE_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_two:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_two);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWO_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWO_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_three:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_three);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_THREE_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_THREE_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_four:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_four);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_FOUR_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_FOUR_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_five:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_five);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_FIVE_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_FIVE_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_six:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_six);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_SIX_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_SIX_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_seven:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_seven);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_SEVEN_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_SEVEN_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_eight:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_eight);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_EIGHT_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_EIGHT_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_nine:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_nine);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_NINE_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_NINE_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_ten:
			intentOneToTen.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_ten);
			intentOneToTen.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TEN_ANSWER);
			intentOneToTen.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TEN_TICK);
			startActivity(intentOneToTen);
			finish();
			break;
		case R.id.level_eleven:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_eleven);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_ELEVEN_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_ELEVEN_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_twelve:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twelve);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWELVE_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWELVE_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_thirteen:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_thirteen);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_THIRTEEN_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_THIRTEEN_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_fourteen:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_fourteen);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_FOURTEEN_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_FOURTEEN_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_fifteen:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_fifteen);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_FIFTEEN_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_FIFTEEN_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_sixteen:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_sixteen);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_SIXTEEN_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_SIXTEEN_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_seventeen:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_seventeen);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_SEVENTEEN_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_SEVENTEEN_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_eighteen:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_eighteen);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_EIGHTEEN_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_EIGHTEEN_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_nineteen:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_nineteen);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_NINETEEN_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_NINETEEN_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_twenty:
			intentElevenToTwenty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twenty);
			intentElevenToTwenty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTY_ANSWER);
			intentElevenToTwenty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTY_TICK);
			startActivity(intentElevenToTwenty);
			finish();
			break;
		case R.id.level_twentyone:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twentyone);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTYONE_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTYONE_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		case R.id.level_twentytwo:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twentytwo);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTYTWO_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTYTWO_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		case R.id.level_twentythree:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twentythree);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTYTHREE_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTYTHREE_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		case R.id.level_twentyfour:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twentyfour);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTYFOUR_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTYFOUR_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		case R.id.level_twentyfive:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twentyfive);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTYFIVE_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTYFIVE_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		case R.id.level_twentysix:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twentysix);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTYSIX_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTYSIX_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		case R.id.level_twentyseven:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twentyseven);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTYSEVEN_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTYSEVEN_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		case R.id.level_twentyeight:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twentyeight);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTYEIGHT_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTYEIGHT_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		case R.id.level_twentynine:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_twentynine);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_TWENTYNINE_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_TWENTYNINE_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		case R.id.level_thirty:
			intentTwentyOneToThirty.putExtra(Constants.LEVEL,
					R.array.addition_nine_level_thirty);
			intentTwentyOneToThirty.putExtra(Constants.ANSWER,
					Constants.OPTION_NINE_LEVEL_THIRTY_ANSWER);
			intentTwentyOneToThirty.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_NINE_THIRTY_TICK);
			startActivity(intentTwentyOneToThirty);
			finish();
			break;
		default:
	...
	public void intializeTicks() {
		...
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_ONE_TICK, false);
		if(!tickStatus) {
			levelOneTick.setVisibility(View.INVISIBLE);
		}

		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWO_TICK, false);
		if(!tickStatus) {
			levelTwoTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_THREE_TICK, false);
		if(!tickStatus) {
			levelThreeTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_FOUR_TICK, false);
		if(!tickStatus) {
			levelFourTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_FIVE_TICK, false);
		if(!tickStatus) {
			levelFiveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_SIX_TICK, false);
		if(!tickStatus) {
			levelSixTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_SEVEN_TICK, false);
		if(!tickStatus) {
			levelSevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_EIGHT_TICK, false);
		if(!tickStatus) {
			levelEightTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_NINE_TICK, false);
		if(!tickStatus) {
			levelNineTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TEN_TICK, false);
		if(!tickStatus) {
			levelTenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_ELEVEN_TICK, false);
		if(!tickStatus) {
			levelElevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWELVE_TICK, false);
		if(!tickStatus) {
			levelTwelveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_THIRTEEN_TICK, false);
		if(!tickStatus) {
			levelThirteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_FOURTEEN_TICK, false);
		if(!tickStatus) {
			levelFourteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_FIFTEEN_TICK, false);
		if(!tickStatus) {
			levelFifteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_SIXTEEN_TICK, false);
		if(!tickStatus) {
			levelSixteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_SEVENTEEN_TICK, false);
		if(!tickStatus) {
			levelSeventeenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_EIGHTEEN_TICK, false);
		if(!tickStatus) {
			levelEighteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_NINETEEN_TICK, false);
		if(!tickStatus) {
			levelNineteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTY_TICK, false);
		if(!tickStatus) {
			levelTwentyTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTYONE_TICK, false);
		if(!tickStatus) {
			levelTwentyOneTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTYTWO_TICK, false);
		if(!tickStatus) {
			levelTwentyTwoTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTYTHREE_TICK, false);
		if(!tickStatus) {
			levelTwentyThreeTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTYFOUR_TICK, false);
		if(!tickStatus) {
			levelTwentyFourTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTYFIVE_TICK, false);
		if(!tickStatus) {
			levelTwentyFiveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTYSIX_TICK, false);
		if(!tickStatus) {
			levelTwentySixTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTYSEVEN_TICK, false);
		if(!tickStatus) {
			levelTwentySevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTYEIGHT_TICK, false);
		if(!tickStatus) {
			levelTwentyEightTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_TWENTYNINE_TICK, false);
		if(!tickStatus) {
			levelTwentyNineTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_NINE_THIRTY_TICK, false);
		if(!tickStatus) {
