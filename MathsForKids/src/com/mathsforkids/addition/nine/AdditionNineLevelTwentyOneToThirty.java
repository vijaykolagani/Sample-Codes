...
public class AdditionNineLevelTwentyOneToThirty extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(AdditionNineLevelTwentyOneToThirty.this, levelTick);
					Intent intent = new Intent(AdditionNineLevelTwentyOneToThirty.this, AdditionNineLevelSelect.class);
