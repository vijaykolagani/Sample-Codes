...
public class AdditionNineLevelOneToTen extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new Dialog(AdditionNineLevelOneToTen.this);
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(AdditionNineLevelOneToTen.this, levelTick);
					Intent intent = new Intent(AdditionNineLevelOneToTen.this, AdditionNineLevelSelect.class);
