...
public class AdditionAboveLevelTwentyOneToThirty extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new Dialog(AdditionAboveLevelTwentyOneToThirty.this);
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(AdditionAboveLevelTwentyOneToThirty.this, levelTick);
					Intent intent = new Intent(AdditionAboveLevelTwentyOneToThirty.this, AdditionAboveLevelSelect.class);
