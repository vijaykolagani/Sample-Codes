...
public class AdditionAboveLevelElevenToTwenty extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new Dialog(AdditionAboveLevelElevenToTwenty.this);
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(AdditionAboveLevelElevenToTwenty.this, levelTick);
					Intent intent = new Intent(AdditionAboveLevelElevenToTwenty.this, AdditionAboveLevelSelect.class);
