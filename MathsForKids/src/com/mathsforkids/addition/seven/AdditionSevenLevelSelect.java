...
public class AdditionSevenLevelSelect extends Activity implements
		OnClickListener {
	...
	private ImageView levelOneTick, levelTwoTick, levelThreeTick, levelFourTick,
			levelFiveTick, levelSixTick, levelSevenTick, levelEightTick, levelNineTick, levelTenTick,
			levelElevenTick, levelTwelveTick, levelThirteenTick, levelFourteenTick,
			levelFifteenTick, levelSixteenTick, levelSeventeenTick, levelEighteenTick,
			levelNineteenTick, levelTwentyTick, levelTwentyOneTick, levelTwentyTwoTick,
			levelTwentyThreeTick, levelTwentyFourTick, levelTwentyFiveTick, levelTwentySixTick,
			levelTwentySevenTick, levelTwentyEightTick, levelTwentyNineTick, levelThirtyTick;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent = new Intent(AdditionSevenLevelSelect.this, AdditionSeven.class);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.level_one:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_one);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_ONE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_ONE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_two:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_two);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWO_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWO_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_three:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_three);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_THREE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_THREE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_four:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_four);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_FOUR_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_FOUR_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_five:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_five);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_FIVE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_FIVE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_six:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_six);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_SIX_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_SIX_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_seven:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_seven);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_SEVEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_SEVEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_eight:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_eight);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_EIGHT_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_EIGHT_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_nine:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_nine);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_NINE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_NINE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_ten:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_ten);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_eleven:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_eleven);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_ELEVEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_ELEVEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twelve:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_twelve);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWELVE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWELVE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_thirteen:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_thirteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_THIRTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_THIRTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_fourteen:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_fourteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_FOURTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_FOURTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_fifteen:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_fifteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_FIFTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_FIFTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_sixteen:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_sixteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_SIXTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_SIXTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_seventeen:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_seventeen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_SEVENTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_SEVENTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_eighteen:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_eighteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_EIGHTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_EIGHTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_nineteen:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_nineteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_NINETEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_NINETEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twenty:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_twenty);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTY_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTY_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyone:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_twentyone);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTYONE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTYONE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentytwo:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_twentytwo);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTYTWO_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTYTWO_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentythree:
			intent.putExtra(Constants.LEVEL,
					R.layout.addition_seven_twentythree);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTYTHREE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTYTHREE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyfour:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_twentyfour);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTYFOUR_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTYFOUR_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyfive:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_twentyfive);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTYFIVE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTYFIVE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentysix:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_twentysix);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTYSIX_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTYSIX_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyseven:
			intent.putExtra(Constants.LEVEL,
					R.layout.addition_seven_twentyseven);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTYSEVEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTYSEVEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyeight:
			intent.putExtra(Constants.LEVEL,
					R.layout.addition_seven_twentyeight);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTYEIGHT_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTYEIGHT_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentynine:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_twentynine);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_TWENTYNINE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_TWENTYNINE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_thirty:
			intent.putExtra(Constants.LEVEL, R.layout.addition_seven_thirty);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_SEVEN_LEVEL_THIRTY_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.ADDITION_SEVEN_THIRTY_TICK);
			startActivity(intent);
			finish();
			break;
		default:
	...
	public void intializeTicks() {
		...
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_ONE_TICK, false);
		if(!tickStatus) {
			levelOneTick.setVisibility(View.INVISIBLE);
		}

		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWO_TICK, false);
		if(!tickStatus) {
			levelTwoTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_THREE_TICK, false);
		if(!tickStatus) {
			levelThreeTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_FOUR_TICK, false);
		if(!tickStatus) {
			levelFourTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_FIVE_TICK, false);
		if(!tickStatus) {
			levelFiveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_SIX_TICK, false);
		if(!tickStatus) {
			levelSixTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_SEVEN_TICK, false);
		if(!tickStatus) {
			levelSevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_EIGHT_TICK, false);
		if(!tickStatus) {
			levelEightTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_NINE_TICK, false);
		if(!tickStatus) {
			levelNineTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TEN_TICK, false);
		if(!tickStatus) {
			levelTenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_ELEVEN_TICK, false);
		if(!tickStatus) {
			levelElevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWELVE_TICK, false);
		if(!tickStatus) {
			levelTwelveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_THIRTEEN_TICK, false);
		if(!tickStatus) {
			levelThirteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_FOURTEEN_TICK, false);
		if(!tickStatus) {
			levelFourteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_FIFTEEN_TICK, false);
		if(!tickStatus) {
			levelFifteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_SIXTEEN_TICK, false);
		if(!tickStatus) {
			levelSixteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_SEVENTEEN_TICK, false);
		if(!tickStatus) {
			levelSeventeenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_EIGHTEEN_TICK, false);
		if(!tickStatus) {
			levelEighteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_NINETEEN_TICK, false);
		if(!tickStatus) {
			levelNineteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTY_TICK, false);
		if(!tickStatus) {
			levelTwentyTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTYONE_TICK, false);
		if(!tickStatus) {
			levelTwentyOneTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTYTWO_TICK, false);
		if(!tickStatus) {
			levelTwentyTwoTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTYTHREE_TICK, false);
		if(!tickStatus) {
			levelTwentyThreeTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTYFOUR_TICK, false);
		if(!tickStatus) {
			levelTwentyFourTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTYFIVE_TICK, false);
		if(!tickStatus) {
			levelTwentyFiveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTYSIX_TICK, false);
		if(!tickStatus) {
			levelTwentySixTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTYSEVEN_TICK, false);
		if(!tickStatus) {
			levelTwentySevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTYEIGHT_TICK, false);
		if(!tickStatus) {
			levelTwentyEightTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_TWENTYNINE_TICK, false);
		if(!tickStatus) {
			levelTwentyNineTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.ADDITION_SEVEN_THIRTY_TICK, false);
		if(!tickStatus) {
