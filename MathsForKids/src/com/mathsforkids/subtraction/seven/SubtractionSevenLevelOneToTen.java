...
public class SubtractionSevenLevelOneToTen extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new Dialog(SubtractionSevenLevelOneToTen.this);
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(SubtractionSevenLevelOneToTen.this, levelTick);
					Intent intent = new Intent(SubtractionSevenLevelOneToTen.this, SubtractionSevenLevelSelect.class);
