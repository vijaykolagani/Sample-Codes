...
public class SubtractionSevenLevelTwentyOneToThirty extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new Dialog(SubtractionSevenLevelTwentyOneToThirty.this);
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(SubtractionSevenLevelTwentyOneToThirty.this, levelTick);
					Intent intent = new Intent(SubtractionSevenLevelTwentyOneToThirty.this, SubtractionSevenLevelSelect.class);
