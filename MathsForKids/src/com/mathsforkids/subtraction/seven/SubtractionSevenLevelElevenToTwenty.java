...
public class SubtractionSevenLevelElevenToTwenty extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new Dialog(SubtractionSevenLevelElevenToTwenty.this);
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(SubtractionSevenLevelElevenToTwenty.this, levelTick);
					Intent intent = new Intent(SubtractionSevenLevelElevenToTwenty.this, SubtractionSevenLevelSelect.class);
