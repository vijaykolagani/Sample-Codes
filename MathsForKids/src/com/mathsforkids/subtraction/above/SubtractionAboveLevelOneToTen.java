...
public class SubtractionAboveLevelOneToTen extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new Dialog(SubtractionAboveLevelOneToTen.this);
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(SubtractionAboveLevelOneToTen.this, levelTick);
					Intent intent = new Intent(SubtractionAboveLevelOneToTen.this, SubtractionAboveLevelSelect.class);
