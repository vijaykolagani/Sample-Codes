package com.mathsforkids.subtraction.four;
...
public class SubtractionFourLevelSelect extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent = new Intent(SubtractionFourLevelSelect.this,
				SubtractionFour.class);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.level_one:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_one);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_ONE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_ONE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_two:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_two);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWO_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWO_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_three:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_three);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_THREE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_THREE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_four:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_four);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_FOUR_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_FOUR_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_five:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_five);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_FIVE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_FIVE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_six:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_six);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_SIX_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_SIX_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_seven:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_seven);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_SEVEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_SEVEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_eight:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_eight);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_EIGHT_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_EIGHT_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_nine:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_nine);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_NINE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_NINE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_ten:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_ten);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_eleven:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_eleven);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_ELEVEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_ELEVEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twelve:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_twelve);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWELVE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWELVE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_thirteen:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_thirteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_THIRTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_THIRTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_fourteen:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_fourteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_FOURTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_FOURTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_fifteen:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_fifteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_FIFTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_FIFTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_sixteen:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_sixteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_SIXTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_SIXTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_seventeen:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_seventeen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_SEVENTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_SEVENTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_eighteen:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_eighteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_EIGHTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_EIGHTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_nineteen:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_nineteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_NINETEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_NINETEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twenty:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_twenty);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTY_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTY_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyone:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_twentyone);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTYONE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTYONE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentytwo:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_twentytwo);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTYTWO_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTYTWO_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentythree:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_twentythree);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTYTHREE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTYTHREE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyfour:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_twentyfour);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTYFOUR_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTYFOUR_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyfive:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_twentyfive);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTYFIVE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTYFIVE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentysix:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_twentysix);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTYSIX_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTYSIX_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyseven:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_twentyseven);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTYSEVEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTYSEVEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyeight:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_twentyeight);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTYEIGHT_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTYEIGHT_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentynine:
			intent.putExtra(Constants.LEVEL,
					R.layout.subtraction_four_twentynine);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_TWENTYNINE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_TWENTYNINE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_thirty:
			intent.putExtra(Constants.LEVEL, R.layout.subtraction_four_thirty);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_FOUR_LEVEL_THIRTY_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.SUBTRACTION_FOUR_THIRTY_TICK);
			startActivity(intent);
			finish();
			break;
		default:
	...
	public void intializeTicks() {
		...
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_ONE_TICK, false);
		if(!tickStatus) {
			levelOneTick.setVisibility(View.INVISIBLE);
		}

		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWO_TICK, false);
		if(!tickStatus) {
			levelTwoTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_THREE_TICK, false);
		if(!tickStatus) {
			levelThreeTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_FOUR_TICK, false);
		if(!tickStatus) {
			levelFourTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_FIVE_TICK, false);
		if(!tickStatus) {
			levelFiveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_SIX_TICK, false);
		if(!tickStatus) {
			levelSixTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_SEVEN_TICK, false);
		if(!tickStatus) {
			levelSevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_EIGHT_TICK, false);
		if(!tickStatus) {
			levelEightTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_NINE_TICK, false);
		if(!tickStatus) {
			levelNineTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TEN_TICK, false);
		if(!tickStatus) {
			levelTenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_ELEVEN_TICK, false);
		if(!tickStatus) {
			levelElevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWELVE_TICK, false);
		if(!tickStatus) {
			levelTwelveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_THIRTEEN_TICK, false);
		if(!tickStatus) {
			levelThirteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_FOURTEEN_TICK, false);
		if(!tickStatus) {
			levelFourteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_FIFTEEN_TICK, false);
		if(!tickStatus) {
			levelFifteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_SIXTEEN_TICK, false);
		if(!tickStatus) {
			levelSixteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_SEVENTEEN_TICK, false);
		if(!tickStatus) {
			levelSeventeenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_EIGHTEEN_TICK, false);
		if(!tickStatus) {
			levelEighteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_NINETEEN_TICK, false);
		if(!tickStatus) {
			levelNineteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTY_TICK, false);
		if(!tickStatus) {
			levelTwentyTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTYONE_TICK, false);
		if(!tickStatus) {
			levelTwentyOneTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTYTWO_TICK, false);
		if(!tickStatus) {
			levelTwentyTwoTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTYTHREE_TICK, false);
		if(!tickStatus) {
			levelTwentyThreeTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTYFOUR_TICK, false);
		if(!tickStatus) {
			levelTwentyFourTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTYFIVE_TICK, false);
		if(!tickStatus) {
			levelTwentyFiveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTYSIX_TICK, false);
		if(!tickStatus) {
			levelTwentySixTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTYSEVEN_TICK, false);
		if(!tickStatus) {
			levelTwentySevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTYEIGHT_TICK, false);
		if(!tickStatus) {
			levelTwentyEightTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_TWENTYNINE_TICK, false);
		if(!tickStatus) {
			levelTwentyNineTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.SUBTRACTION_FOUR_THIRTY_TICK, false);
		if(!tickStatus) {
