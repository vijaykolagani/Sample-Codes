...
public class SubtractionNineLevelOneToTen extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(SubtractionNineLevelOneToTen.this, levelTick);
					Intent intent = new Intent(SubtractionNineLevelOneToTen.this, SubtractionNineLevelSelect.class);
