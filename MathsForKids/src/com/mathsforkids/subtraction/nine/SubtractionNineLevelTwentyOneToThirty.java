...
public class SubtractionNineLevelTwentyOneToThirty extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new Dialog(SubtractionNineLevelTwentyOneToThirty.this);
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(SubtractionNineLevelTwentyOneToThirty.this, levelTick);
					Intent intent = new Intent(SubtractionNineLevelTwentyOneToThirty.this, SubtractionNineLevelSelect.class);
