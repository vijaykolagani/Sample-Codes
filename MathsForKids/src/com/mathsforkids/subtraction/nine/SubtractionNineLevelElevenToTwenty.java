...
public class SubtractionNineLevelElevenToTwenty extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new Dialog(SubtractionNineLevelElevenToTwenty.this);
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(SubtractionNineLevelElevenToTwenty.this, levelTick);
					Intent intent = new Intent(SubtractionNineLevelElevenToTwenty.this, SubtractionNineLevelSelect.class);
