package com.mathsforkids.multiplication.hard;
...
public class MultiplicationHardLevelSelect extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent = new Intent(MultiplicationHardLevelSelect.this, MultiplicationHard.class);
	...
	public void onClick(View v) {
		...
		case R.id.level_one:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_one);
			intent.putExtra(Constants.ANSWER, Constants.OPTION_ABOVE_LEVEL_ONE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_ONE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_two:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_two);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWO_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWO_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_three:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_three);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_THREE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_THREE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_four:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_four);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_FOUR_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_FOUR_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_five:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_five);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_FIVE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_FIVE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_six:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_six);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_SIX_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_SIX_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_seven:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_seven);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_SEVEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_SEVEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_eight:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_eight);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_EIGHT_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_EIGHT_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_nine:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_nine);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_NINE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_NINE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_ten:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_ten);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_eleven:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_eleven);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_ELEVEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_ELEVEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twelve:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twelve);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWELVE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWELVE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_thirteen:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_thirteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_THIRTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_THIRTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_fourteen:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_fourteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_FOURTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_FOURTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_fifteen:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_fifteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_FIFTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_FIFTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_sixteen:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_sixteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_SIXTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_SIXTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_seventeen:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_seventeen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_SEVENTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_SEVENTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_eighteen:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_eighteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_EIGHTEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_EIGHTEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_nineteen:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_nineteen);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_NINETEEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_NINETEEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twenty:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twenty);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTY_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTY_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyone:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twentyone);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTYONE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTYONE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentytwo:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twentytwo);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTYTWO_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTYTWO_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentythree:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twentythree);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTYTHREE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTYTHREE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyfour:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twentyfour);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTYFOUR_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTYFOUR_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyfive:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twentyfive);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTYFIVE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTYFIVE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentysix:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twentysix);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTYSIX_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTYSIX_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyseven:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twentyseven);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTYSEVEN_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTYSEVEN_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentyeight:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twentyeight);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTYEIGHT_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTYEIGHT_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_twentynine:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_twentynine);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_TWENTYNINE_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_TWENTYNINE_TICK);
			startActivity(intent);
			finish();
			break;
		case R.id.level_thirty:
			intent.putExtra(Constants.LEVEL,
					R.array.multiplication_hard_level_thirty);
			intent.putExtra(Constants.ANSWER,
					Constants.OPTION_ABOVE_LEVEL_THIRTY_ANSWER);
			intent.putExtra(Constants.LEVEL_TICK, Constants.MULTIPLICATION_HARD_THIRTY_TICK);
			startActivity(intent);
			finish();
			break;
		default:
	...
	public void intializeTicks() {
		...
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_ONE_TICK, false);
		if(!tickStatus) {
			levelOneTick.setVisibility(View.INVISIBLE);
		}

		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWO_TICK, false);
		if(!tickStatus) {
			levelTwoTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_THREE_TICK, false);
		if(!tickStatus) {
			levelThreeTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_FOUR_TICK, false);
		if(!tickStatus) {
			levelFourTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_FIVE_TICK, false);
		if(!tickStatus) {
			levelFiveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_SIX_TICK, false);
		if(!tickStatus) {
			levelSixTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_SEVEN_TICK, false);
		if(!tickStatus) {
			levelSevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_EIGHT_TICK, false);
		if(!tickStatus) {
			levelEightTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_NINE_TICK, false);
		if(!tickStatus) {
			levelNineTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TEN_TICK, false);
		if(!tickStatus) {
			levelTenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_ELEVEN_TICK, false);
		if(!tickStatus) {
			levelElevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWELVE_TICK, false);
		if(!tickStatus) {
			levelTwelveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_THIRTEEN_TICK, false);
		if(!tickStatus) {
			levelThirteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_FOURTEEN_TICK, false);
		if(!tickStatus) {
			levelFourteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_FIFTEEN_TICK, false);
		if(!tickStatus) {
			levelFifteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_SIXTEEN_TICK, false);
		if(!tickStatus) {
			levelSixteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_SEVENTEEN_TICK, false);
		if(!tickStatus) {
			levelSeventeenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_EIGHTEEN_TICK, false);
		if(!tickStatus) {
			levelEighteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_NINETEEN_TICK, false);
		if(!tickStatus) {
			levelNineteenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTY_TICK, false);
		if(!tickStatus) {
			levelTwentyTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTYONE_TICK, false);
		if(!tickStatus) {
			levelTwentyOneTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTYTWO_TICK, false);
		if(!tickStatus) {
			levelTwentyTwoTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTYTHREE_TICK, false);
		if(!tickStatus) {
			levelTwentyThreeTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTYFOUR_TICK, false);
		if(!tickStatus) {
			levelTwentyFourTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTYFIVE_TICK, false);
		if(!tickStatus) {
			levelTwentyFiveTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTYSIX_TICK, false);
		if(!tickStatus) {
			levelTwentySixTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTYSEVEN_TICK, false);
		if(!tickStatus) {
			levelTwentySevenTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTYEIGHT_TICK, false);
		if(!tickStatus) {
			levelTwentyEightTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_TWENTYNINE_TICK, false);
		if(!tickStatus) {
			levelTwentyNineTick.setVisibility(View.INVISIBLE);
		}
		
		tickStatus = prefs.getBoolean(Constants.MULTIPLICATION_HARD_THIRTY_TICK, false);
		if(!tickStatus) {
