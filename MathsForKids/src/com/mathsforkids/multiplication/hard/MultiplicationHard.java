...
public class MultiplicationHard extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(MultiplicationHard.this, levelTick);
					Intent intent = new Intent(MultiplicationHard.this, MultiplicationHardLevelSelect.class);
