...
public class MultiplicationMedium extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(MultiplicationMedium.this, levelTick);
					Intent intent = new Intent(MultiplicationMedium.this, MultiplicationMediumLevelSelect.class);
