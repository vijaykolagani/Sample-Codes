...
public class MultiplicationEasy extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		if (v.getId() == LEVEL_ANSWER) {
			...
			next.setOnClickListener(new OnClickListener() {	
				public void onClick(View v) {
					dialog.dismiss();
					Utilities.updateTickVisibility(MultiplicationEasy.this, levelTick);
					Intent intent = new Intent(MultiplicationEasy.this, MultiplicationEasyLevelSelect.class);
