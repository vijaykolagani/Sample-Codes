...
public class QuizNormalHard extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.quiz_normal_hard);

		prefs = getSharedPreferences(Constants.PREFS, MODE_PRIVATE);
		best = prefs.getInt(Constants.QUIZ_NORMAL_HARD_BEST, 0);
	...
	protected void onPause() {
		super.onPause();
		if (score > best) {
			Utilities.updateQuizBest(QuizNormalHard.this, Constants.QUIZ_NORMAL_HARD_BEST, score);			
		}
	}
