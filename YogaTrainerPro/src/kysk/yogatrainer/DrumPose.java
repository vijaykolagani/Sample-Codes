...
public class DrumPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(DrumPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(DrumPose.this, PoseTaking.class);
				i.putExtra("pose", 10);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(DrumPose.this, PoseReleasing.class);
				i.putExtra("pose", 10);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(DrumPose.this, PoseBenefits.class);
				i.putExtra("pose", 10);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
