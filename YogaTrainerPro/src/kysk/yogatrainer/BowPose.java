...
public class BowPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(BowPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(BowPose.this, PoseTaking.class);
				i.putExtra("pose", 5);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(BowPose.this, PoseReleasing.class);
				i.putExtra("pose", 5);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(BowPose.this, PoseBenefits.class);
				i.putExtra("pose", 5);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
