...
public class SingleToeBalancePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(SingleToeBalancePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(SingleToeBalancePose.this, PoseTaking.class);
				i.putExtra("pose", 31);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(SingleToeBalancePose.this, PoseReleasing.class);
				i.putExtra("pose", 31);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(SingleToeBalancePose.this, PoseBenefits.class);
				i.putExtra("pose", 31);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
