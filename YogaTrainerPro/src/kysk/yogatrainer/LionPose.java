...
public class LionPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(LionPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(LionPose.this, PoseTaking.class);
				i.putExtra("pose", 26);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(LionPose.this, PoseReleasing.class);
				i.putExtra("pose", 26);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(LionPose.this, PoseBenefits.class);
				i.putExtra("pose", 26);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
