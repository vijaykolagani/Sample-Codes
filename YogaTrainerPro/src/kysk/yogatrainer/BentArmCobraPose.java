...
public class BentArmCobraPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(BentArmCobraPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(BentArmCobraPose.this, PoseTaking.class);
				i.putExtra("pose", 3);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(BentArmCobraPose.this, PoseReleasing.class);
				i.putExtra("pose", 3);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(BentArmCobraPose.this, PoseBenefits.class);
				i.putExtra("pose", 3);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
