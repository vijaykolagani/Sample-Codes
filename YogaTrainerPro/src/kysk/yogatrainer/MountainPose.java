...
public class MountainPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(MountainPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(MountainPose.this, PoseTaking.class);
				i.putExtra("pose", 28);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(MountainPose.this, PoseReleasing.class);
				i.putExtra("pose", 28);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(MountainPose.this, PoseBenefits.class);
				i.putExtra("pose", 28);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
