...
public class ThunderboltPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(ThunderboltPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(ThunderboltPose.this, PoseTaking.class);
				i.putExtra("pose", 33);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ThunderboltPose.this, PoseReleasing.class);
				i.putExtra("pose", 33);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ThunderboltPose.this, PoseBenefits.class);
				i.putExtra("pose", 33);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
