...
public class InvertedPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(InvertedPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(InvertedPose.this, PoseTaking.class);
				i.putExtra("pose", 22);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(InvertedPose.this, PoseReleasing.class);
				i.putExtra("pose", 22);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(InvertedPose.this, PoseBenefits.class);
				i.putExtra("pose", 22);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
