...
public class FishPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(FishPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(FishPose.this, PoseTaking.class);
				i.putExtra("pose", 13);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(FishPose.this, PoseReleasing.class);
				i.putExtra("pose", 13);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(FishPose.this, PoseBenefits.class);
				i.putExtra("pose", 13);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
