...
public class YogaTrainerActivity extends ListActivity {

	private LayoutInflater inflater;
	private Vector<RowData> data;
	RowData rd;
	CustomAdapter adapter;
	Integer[] imageIds = { R.drawable.difficult_pose, R.drawable.balance_pose,
			R.drawable.gas_release_pose, R.drawable.bent_arm_pose };
	String[] positions;
	...
	public void onListItemClick(ListView parent, View v, int position, long id) {
		if (position == 0)
			startActivity(new Intent(YogaTrainerActivity.this,
					StandingPosition.class));
		else if (position == 1)
			startActivity(new Intent(YogaTrainerActivity.this,
					SittingPosition.class));
		else if (position == 2)
			startActivity(new Intent(YogaTrainerActivity.this,
					SupinePosition.class));
		else if (position == 3)
			startActivity(new Intent(YogaTrainerActivity.this,
					PronePosition.class));
	}
