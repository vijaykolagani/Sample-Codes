...
public class SingleLegToHeadPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(SingleLegToHeadPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(SingleLegToHeadPose.this, PoseTaking.class);
				i.putExtra("pose", 30);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(SingleLegToHeadPose.this, PoseReleasing.class);
				i.putExtra("pose", 30);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(SingleLegToHeadPose.this, PoseBenefits.class);
				i.putExtra("pose", 30);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
