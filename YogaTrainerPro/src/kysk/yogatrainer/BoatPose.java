...
public class BoatPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(BoatPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(BoatPose.this, PoseTaking.class);
				i.putExtra("pose", 4);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(BoatPose.this, PoseReleasing.class);
				i.putExtra("pose", 4);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(BoatPose.this, PoseBenefits.class);
				i.putExtra("pose", 4);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
