...
public class LotusPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(LotusPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(LotusPose.this, PoseTaking.class);
				i.putExtra("pose", 27);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(LotusPose.this, PoseReleasing.class);
				i.putExtra("pose", 27);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(LotusPose.this, PoseBenefits.class);
				i.putExtra("pose", 27);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
