...
public class BalancePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(BalancePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(BalancePose.this, PoseTaking.class);
				i.putExtra("pose", 2);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(BalancePose.this, PoseReleasing.class);
				i.putExtra("pose", 2);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(BalancePose.this, PoseBenefits.class);
				i.putExtra("pose", 2);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
