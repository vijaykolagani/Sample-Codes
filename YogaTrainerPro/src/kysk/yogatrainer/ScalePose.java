...
public class ScalePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(ScalePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(ScalePose.this, PoseTaking.class);
				i.putExtra("pose", 29);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ScalePose.this, PoseReleasing.class);
				i.putExtra("pose", 29);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ScalePose.this, PoseBenefits.class);
				i.putExtra("pose", 29);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
