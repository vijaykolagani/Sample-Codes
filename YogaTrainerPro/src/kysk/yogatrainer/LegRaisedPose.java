...
public class LegRaisedPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(LegRaisedPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(LegRaisedPose.this, PoseTaking.class);
				i.putExtra("pose", 24);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(LegRaisedPose.this, PoseReleasing.class);
				i.putExtra("pose", 24);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(LegRaisedPose.this, PoseBenefits.class);
				i.putExtra("pose", 24);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
