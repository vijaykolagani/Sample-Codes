...
public class HalfLotusBoundPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(HalfLotusBoundPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(HalfLotusBoundPose.this, PoseTaking.class);
				i.putExtra("pose", 19);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(HalfLotusBoundPose.this, PoseReleasing.class);
				i.putExtra("pose", 19);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(HalfLotusBoundPose.this, PoseBenefits.class);
				i.putExtra("pose", 19);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
