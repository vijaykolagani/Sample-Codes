...
public class TwistedTrianglePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(TwistedTrianglePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(TwistedTrianglePose.this, PoseTaking.class);
				i.putExtra("pose", 38);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(TwistedTrianglePose.this, PoseReleasing.class);
				i.putExtra("pose", 38);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(TwistedTrianglePose.this, PoseBenefits.class);
				i.putExtra("pose", 38);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
