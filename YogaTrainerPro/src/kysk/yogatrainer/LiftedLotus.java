...
public class LiftedLotus extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(LiftedLotus.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(LiftedLotus.this, PoseTaking.class);
				i.putExtra("pose", 25);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(LiftedLotus.this, PoseReleasing.class);
				i.putExtra("pose", 25);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(LiftedLotus.this, PoseBenefits.class);
				i.putExtra("pose", 25);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
