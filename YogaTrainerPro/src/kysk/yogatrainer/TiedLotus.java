...
public class TiedLotus extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(TiedLotus.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(TiedLotus.this, PoseTaking.class);
				i.putExtra("pose", 34);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(TiedLotus.this, PoseReleasing.class);
				i.putExtra("pose", 34);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(TiedLotus.this, PoseBenefits.class);
				i.putExtra("pose", 34);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
