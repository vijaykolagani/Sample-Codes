...
public class EaglePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(EaglePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(EaglePose.this, PoseTaking.class);
				i.putExtra("pose", 11);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(EaglePose.this, PoseReleasing.class);
				i.putExtra("pose", 11);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(EaglePose.this, PoseBenefits.class);
				i.putExtra("pose", 11);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
