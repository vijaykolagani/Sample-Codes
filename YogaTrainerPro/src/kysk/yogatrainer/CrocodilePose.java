...
public class CrocodilePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(CrocodilePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(CrocodilePose.this, PoseTaking.class);
				i.putExtra("pose", 7);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(CrocodilePose.this, PoseReleasing.class);
				i.putExtra("pose", 7);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(CrocodilePose.this, PoseBenefits.class);
				i.putExtra("pose", 7);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
