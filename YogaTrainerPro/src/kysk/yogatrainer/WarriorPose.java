...
public class WarriorPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(WarriorPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(WarriorPose.this, PoseTaking.class);
				i.putExtra("pose", 39);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(WarriorPose.this, PoseReleasing.class);
				i.putExtra("pose", 39);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(WarriorPose.this, PoseBenefits.class);
				i.putExtra("pose", 39);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
