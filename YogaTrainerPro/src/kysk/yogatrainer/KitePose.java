...
public class KitePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(KitePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(KitePose.this, PoseTaking.class);
				i.putExtra("pose", 23);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(KitePose.this, PoseReleasing.class);
				i.putExtra("pose", 23);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(KitePose.this, PoseBenefits.class);
				i.putExtra("pose", 23);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
