...
public class HandToLegPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(HandToLegPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(HandToLegPose.this, PoseTaking.class);
				i.putExtra("pose", 20);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(HandToLegPose.this, PoseReleasing.class);
				i.putExtra("pose", 20);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(HandToLegPose.this, PoseBenefits.class);
				i.putExtra("pose", 20);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
