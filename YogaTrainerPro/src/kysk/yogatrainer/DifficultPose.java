...
public class DifficultPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(DifficultPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(DifficultPose.this, PoseTaking.class);
				i.putExtra("pose", 9);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(DifficultPose.this, PoseReleasing.class);
				i.putExtra("pose", 9);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(DifficultPose.this, PoseBenefits.class);
				i.putExtra("pose", 9);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
