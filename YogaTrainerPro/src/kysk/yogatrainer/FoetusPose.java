...
public class FoetusPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(FoetusPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(FoetusPose.this, PoseTaking.class);
				i.putExtra("pose", 14);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(FoetusPose.this, PoseReleasing.class);
				i.putExtra("pose", 14);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(FoetusPose.this, PoseBenefits.class);
				i.putExtra("pose", 14);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
