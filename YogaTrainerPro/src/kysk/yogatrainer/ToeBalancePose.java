...
public class ToeBalancePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(ToeBalancePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(ToeBalancePose.this, PoseTaking.class);
				i.putExtra("pose", 35);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ToeBalancePose.this, PoseReleasing.class);
				i.putExtra("pose", 35);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ToeBalancePose.this, PoseBenefits.class);
				i.putExtra("pose", 35);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
