...
public class ForwardBend extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(ForwardBend.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(ForwardBend.this, PoseTaking.class);
				i.putExtra("pose", 15);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ForwardBend.this, PoseReleasing.class);
				i.putExtra("pose", 15);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ForwardBend.this, PoseBenefits.class);
				i.putExtra("pose", 15);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
