...
public class GasReleasePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(GasReleasePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(GasReleasePose.this, PoseTaking.class);
				i.putExtra("pose", 17);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(GasReleasePose.this, PoseReleasing.class);
				i.putExtra("pose", 17);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(GasReleasePose.this, PoseBenefits.class);
				i.putExtra("pose", 17);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
