...
public class HeadStandPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(HeadStandPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(HeadStandPose.this, PoseTaking.class);
				i.putExtra("pose", 21);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(HeadStandPose.this, PoseReleasing.class);
				i.putExtra("pose", 21);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(HeadStandPose.this, PoseBenefits.class);
				i.putExtra("pose", 21);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
