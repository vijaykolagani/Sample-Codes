...
public class TrianglePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(TrianglePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(TrianglePose.this, PoseTaking.class);
				i.putExtra("pose", 37);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(TrianglePose.this, PoseReleasing.class);
				i.putExtra("pose", 37);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(TrianglePose.this, PoseBenefits.class);
				i.putExtra("pose", 37);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
