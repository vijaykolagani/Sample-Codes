...
public class TreePose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(TreePose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(TreePose.this, PoseTaking.class);
				i.putExtra("pose", 36);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(TreePose.this, PoseReleasing.class);
				i.putExtra("pose", 36);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(TreePose.this, PoseBenefits.class);
				i.putExtra("pose", 36);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
