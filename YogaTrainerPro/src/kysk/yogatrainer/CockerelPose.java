...
public class CockerelPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(CockerelPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(CockerelPose.this, PoseTaking.class);
				i.putExtra("pose", 6);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(CockerelPose.this, PoseReleasing.class);
				i.putExtra("pose", 6);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(CockerelPose.this, PoseBenefits.class);
				i.putExtra("pose", 6);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
