...
public class FullWheelPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(FullWheelPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(FullWheelPose.this, PoseTaking.class);
				i.putExtra("pose", 16);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(FullWheelPose.this, PoseReleasing.class);
				i.putExtra("pose", 16);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(FullWheelPose.this, PoseBenefits.class);
				i.putExtra("pose", 16);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
