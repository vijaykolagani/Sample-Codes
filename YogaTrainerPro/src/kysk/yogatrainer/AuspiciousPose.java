...
public class AuspiciousPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(AuspiciousPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(AuspiciousPose.this, PoseTaking.class);
				i.putExtra("pose", 1);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(AuspiciousPose.this, PoseReleasing.class);
				i.putExtra("pose", 1);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(AuspiciousPose.this, PoseBenefits.class);
				i.putExtra("pose", 1);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		start_timer.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (time == 0) {
					Toast.makeText(getApplicationContext(),
							getString(R.string.st_text), Toast.LENGTH_SHORT)
							.show();
				} else {
