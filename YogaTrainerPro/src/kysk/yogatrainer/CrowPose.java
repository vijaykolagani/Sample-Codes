...
public class CrowPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(CrowPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(CrowPose.this, PoseTaking.class);
				i.putExtra("pose", 8);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(CrowPose.this, PoseReleasing.class);
				i.putExtra("pose", 8);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(CrowPose.this, PoseBenefits.class);
				i.putExtra("pose", 8);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
