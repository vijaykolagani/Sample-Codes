...
public class FerociousPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(FerociousPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(FerociousPose.this, PoseTaking.class);
				i.putExtra("pose", 12);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(FerociousPose.this, PoseReleasing.class);
				i.putExtra("pose", 12);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(FerociousPose.this, PoseBenefits.class);
				i.putExtra("pose", 12);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
