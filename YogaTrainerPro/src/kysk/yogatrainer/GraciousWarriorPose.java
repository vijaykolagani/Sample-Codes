...
public class GraciousWarriorPose extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		dialog = new Dialog(GraciousWarriorPose.this);
		...
		taking.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(GraciousWarriorPose.this, PoseTaking.class);
				i.putExtra("pose", 18);
		...
		releasing.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(GraciousWarriorPose.this, PoseReleasing.class);
				i.putExtra("pose", 18);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
		...
		benefits.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(GraciousWarriorPose.this, PoseBenefits.class);
				i.putExtra("pose", 18);
				i.putExtra("pose_name", pose_name.getText());
				startActivity(i);
			}
