...
public class TrackTwo extends Activity implements OnGameOverListener, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		best = prefs.getInt(Constants.PREFS_TRACKTWO_BEST, 0);
		...
		gameView = new GameView(this, soundManager, Constants.TRACK_TWO);
	...
	public void onGameOver(int score, int swipes, long elapsedTime) {
		...
		editor = prefs.edit();
		if (score > best) {
			editor.putInt(Constants.PREFS_TRACKTWO_BEST, score);
		}
		...
		editor.commit();
		Intent summary = new Intent(TrackTwo.this, Summary.class);
		summary.putExtra(Constants.EXTRA_TRACK, Constants.TRACK_TWO);
