...
public class TrackFour extends Activity implements OnGameOverListener, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		best = prefs.getInt(Constants.PREFS_TRACKFOUR_BEST, 0);
		...
		gameView = new GameView(this, soundManager, Constants.TRACK_FOUR);
	...
	public void onGameOver(int score, int swipes, long elapsedTime) {
		...
		editor = prefs.edit();
		if (score > best) {
			editor.putInt(Constants.PREFS_TRACKFOUR_BEST, score);
		}
		...
		editor.commit();
		Intent summary = new Intent(TrackFour.this, Summary.class);
		summary.putExtra(Constants.EXTRA_TRACK, Constants.TRACK_FOUR);
