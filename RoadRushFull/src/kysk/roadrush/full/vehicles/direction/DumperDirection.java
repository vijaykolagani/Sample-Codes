...
public class DumperDirection implements VehicleDirection {
	
	private Dumper dumper;
	private int track;
	
	public DumperDirection(Dumper dumper, int track) {
		this.dumper = dumper;
		this.track = track;
	}
	...
	public void rightPath(int path, int width, int height, Canvas canvas) {
		dumper.setStartX(canvas.getWidth() + width);
		switch (track) {
		case 1:
		case 2:
		case 3:
			switch (path) {
			case 0:
				dumper.setStartY(canvas.getHeight() / 2 + height / 2 + 10);
				break;
			case 1:
				dumper.setStartY(canvas.getHeight() / 2 + 5);
				break;
			case 2:
				dumper.setStartY(canvas.getHeight() / 2 - height / 2 - 2);
				break;
			case 3:
				dumper.setStartY(canvas.getHeight() / 2 - height - 10);
				break;
			}
			break;
		case 4:
			switch (path) {
			case 0:
				dumper.setStartY(canvas.getHeight() / 2 + 2 * height - 47);
				break;
			case 1:
				dumper.setStartY(canvas.getHeight() / 2 + height / 2 + 5);
				break;
			case 2:
				dumper.setStartY(canvas.getHeight() / 2 - height - 2);
				break;
			case 3:
				dumper.setStartY(canvas.getHeight() / 2 - 2 * height + 25);
				break;
			}
			break;
		}
	...
	public void topPath(int path, int width, int height, Canvas canvas) {
		dumper.setStartY(0 - height);
		switch (track) {
		case 1:
		case 2:
			switch (path) {
			case 0:
				dumper.setStartX(canvas.getWidth() / 2 - width - 20);
				break;
			case 1:
				dumper.setStartX(canvas.getWidth() / 2 - width / 2 - 10);
				break;
			case 2:
				dumper.setStartX(canvas.getWidth() / 2 + 10);
				break;
			case 3:
				dumper.setStartX(canvas.getWidth() / 2 + width);
				break;
			}
			break;
		case 3:
		case 4:
			switch (path) {
			case 0:
				dumper.setStartX(canvas.getWidth() / 2 - 2 * width - 15);
				break;
			case 1:
				dumper.setStartX(canvas.getWidth() / 2 - width - 25);
				break;
			case 2:
				dumper.setStartX(canvas.getWidth() / 2 + width);
				break;
			case 3:
				dumper.setStartX(canvas.getWidth() / 2 + 2 * width - 10);
				break;
			}
			break;
		}
	...
	public void bottomPath(int path, int width, int height, Canvas canvas) {
		dumper.setStartY(canvas.getHeight() + height);
		switch (track) {
		case 1:
		case 2:
			switch (path) {
